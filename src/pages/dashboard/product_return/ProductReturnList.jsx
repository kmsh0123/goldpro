...
import { useGetDamageQuery } from "@/feature/api/damageApi/damageApi";
import { useGetProductReturnQuery } from "@/feature/api/productReturnApi/productReturnApi";
...
const ProductReturnList = () => {
  ...
  const {
    ...
    currentPageData,
    handlePageChange,
  } = usePaginatedList({ queryHook: useGetProductReturnQuery, limit: 10 });
  ...
  const csvConfig = getCSVExportConfig(csvData, csvHeaders, "ProductReturnList.csv");
    ...
    <div className="space-y-4 p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Product Return List</h1>
          <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded-full text-sm">
            {totalItems} return lists
          </span>
        </div>
      </div>
