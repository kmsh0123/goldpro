...
const DailyPurchaseReport = () => {
  ...
  return (
    <div className="space-y-4 p-6">
      ...
      {/* Search */}
      {/* <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 p-4 bg-white rounded-lg bpurchase">
        <div className="w-full sm:w-auto">
          <Input
            placeholder="Search qualities..."
            className="w-full sm:w-64 rounded-lg bpurchase-gray-300"
          />
        </div>
