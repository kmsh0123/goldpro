...
import { useDeletePaymentCategoryMutation, useGetPaymentCategoryQuery } from "@/feature/api/paymentCategory/paymentCategory";
...
export default function PaymentCategory() {
  ...
  // Delete mutation
  const [deletePaymentCategory, { isLoading: isDeleting }] = useDeletePaymentCategoryMutation();
    ...
    <div className="space-y-4 p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Payment Category Management</h1>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 p-4 bg-white rounded-lg border">
        ...
        <Button className="bg-yellow-600 hover:bg-yellow-700 text-white rounded-lg">
          <Link to="/payment/payment-category-list/create" className="flex items-center gap-2">
      ...
      <div className="bg-white rounded-lg border shadow-sm">
        <PaginatedTable
          columns={["No.", "Created Date", "Payment Category Name", "Actions"]}
          ...
          renderRow={(item, index) => (
            <tr key={item.id} className="hover:bg-gray-50">
              ...
              <td className="py-3 px-4 text-center font-medium">{item.category_name}</td>
